...
public class CreateAccountSteps extends SeleniumUtility {
    ...
    public void fillUpCreateAccountForm() {
        ...
        sendText(CreateAccountPageObject.FIRST_NAME_INPUT, "Hamed");
        sendText(CreateAccountPageObject.LAST_NAME_INPUT, "A");
        ...
        sendText(CreateAccountPageObject.DATE_OF_BIRTH, "07/19/1992");
    }
    ...
    public void whenTheUserFillUpSignUpForm() {
        sendText(CreateAccountPageObject.USERNAME_INPUT, "hamed.attayi@tekschool.us");
        sendText(CreateAccountPageObject.PASSWORD_INPUT, "Qwerty@1992");
        sendText(CreateAccountPageObject.CONFIRM_PASSWORD_INPUT, "Qwerty@1992");
    }
    ...
    public void fillUpCreateAccountFormPage() {
        ...
        sendText(CreateAccountPageObject.EMAIL_INPUT, "hamed.attayi@tekschool.us");
        selectFromDropDown(CreateAccountPageObject.PREFIX_SELECT, "Mr.");
        sendText(CreateAccountPageObject.FIRST_NAME_INPUT, "Hamed");
        sendText(CreateAccountPageObject.LAST_NAME_INPUT, "A");
        selectFromDropDown(CreateAccountPageObject.GENDER_SELECT, "Male");
